      ...
      >
        ...
        <div style={{ display: 'flex', gap: 12 }}>
          <button onClick={onClose} style={{
            ...
            background: 'transparent', color: '#64748B', fontSize: 14, fontWeight: 600, cursor: 'pointer', fontFamily: 'var(--font-sans)'
          }}>Cancel</button>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, flexShrink: 0, alignSelf: 'center' }}>
            <motion.button
              ...
              style={{
                ...
                fontFamily: 'var(--font-sans)', boxShadow: '0 4px 12px rgba(13,196,161,0.25)',
                whiteSpace: 'nowrap'
              }}
            >
...
export default function AdminDashboard() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--mc-sky)', fontFamily: 'var(--font-sans)' }}>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
          ...
          {docsLoading ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {[1, 2, 3].map(n => (
                <div key={n} style={{
                  background: 'rgba(255,255,255,0.82)', borderRadius: 18, padding: '22px 24px',
                  border: '1px solid rgba(255,255,255,0.9)',
