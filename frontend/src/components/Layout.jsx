...
export default function Layout({ children }) {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: P.sky, fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <motion.aside
        ...
        style={{ background: P.navy, display: 'flex', flexDirection: 'column', position: 'fixed', top: 0, left: 0, bottom: 0, zIndex: 100, overflow: 'hidden' }}>
      ...
      {/* ── MAIN CONTENT ── */}
      <div style={{ marginLeft: collapsed ? 68 : 240, flex: 1, transition: 'margin-left 0.3s cubic-bezier(0.22,1,0.36,1)', display: 'flex', flexDirection: 'column' }}>

        {/* Top bar */}
        <header style={{ height: 64, background: 'rgba(255,255,255,0.7)', backdropFilter: 'blur(16px)', borderBottom: `1px solid ${P.border}`, display: 'flex', alignItems: 'center', justifyContent: 'flex-end', padding: '0 32px', position: 'sticky', top: 0, zIndex: 50 }}>
