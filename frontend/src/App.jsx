...
// ── Loader ────────────────────────────────────────────────
const Spinner = () => (
  <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--mc-sky)' }}>
...
function Placeholder({ title }) {
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--mc-sky)', fontFamily: 'var(--font-sans)' }}>
...
<Route path="/profile"
  element={<ProtectedRoute role="patient"><Layout><PatientProfile /></Layout></ProtectedRoute>} />
      ...
      <Route path="/prescriptions"
        element={<ProtectedRoute role="patient"><Layout><PatientPrescriptions /></Layout></ProtectedRoute>} />
      ...
      <Route path="/doctor/analytics"
        element={<ProtectedRoute role="doctor"><DoctorLayout><DoctorAnalytics /></DoctorLayout></ProtectedRoute>} />
      ...
      <Route path="/admin/doctors"
        element={<AdminRoute><AdminDoctors /></AdminRoute>} />
